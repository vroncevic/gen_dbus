...
class GenDBus(ATSCli):
    '''
        ...
        It defines:
            ...
            :methods:
                | __init__ - Initials GenDBus constructor.
                | process - Processes and runs operations.
    '''

    _GEN_VERBOSE: str = 'GEN_DBUS'
    ...
    def __init__(self, verbose: bool = False) -> None:
        ...
        if self.is_operational():
            ...
            self.add_new_option(
                ...
                help='set type of project (posix_c | posix_cxx | posix_py)'
            )
            self.add_new_option(
